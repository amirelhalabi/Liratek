...
import { ClientService, resetClientService, getClientService } from '../ClientService';
...
describe('ClientService', () => {
  ...
  describe('searchClients', () => {
    it('returns matching clients', () => {
      const mockClients = [{ id: 1, full_name: 'John Doe', phone_number: '123' }];
  ...
  describe('createClient', () => {
    ...
    it('returns error for missing name', () => {
      ...
      expect(result).toEqual({ success: false, error: 'Client name is required' });
    ...
    it('returns error for duplicate phone', () => {
      ...
      expect(result).toEqual({ success: false, error: 'Phone number already registered' });
    });
