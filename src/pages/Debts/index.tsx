            ...
            <div className="w-1/3 flex flex-col bg-slate-800 rounded-xl border border-slate-700 shadow-xl overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-2">
                    {filteredDebtors.map(client => (
                        ...
                        >
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="font-bold text-slate-200">{client.full_name}</div>
                    ...
                    {filteredDebtors.length === 0 && (
                        <div className="text-center text-slate-500 py-8">No debtors found.</div>
                    )}
                </div>
            </div>
                            ...
                            <table className="w-full">
                                <thead className="text-left text-slate-400 border-b border-slate-700">
                                    <tr>
                                        ...
                                        <th className="pb-3 text-sm font-medium text-right">Amount (USD)</th>
                                    </tr>
                                </thead>
            ...
            {showRepaymentModal && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 w-full max-w-md shadow-2xl">
                        <h3 className="text-xl font-bold text-white mb-4">Process Repayment</h3>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-medium text-slate-400 mb-1 uppercase">Amount USD</label>
                                <div className="relative">
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-400 mb-1 uppercase">Amount LBP</label>
                                <div className="relative">
                                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-slate-500">LBP</span>
                                    <input
                                        type="number"
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-400 mb-1 uppercase">Note</label>
                                <input
                                    type="text"
                                    value={repayNote}
