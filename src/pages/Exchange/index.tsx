            ...
            <div className="flex gap-6 h-full min-h-0">
                ...
                <div className="w-1/3 min-w-[380px] bg-slate-800 rounded-xl border border-slate-700/50 shadow-xl p-6 flex flex-col">
                    ...
                    <div className="space-y-6 flex-1">
                        {/* Rate Input */}
                        <div>
                            <label className="block text-xs font-medium text-slate-400 mb-1 uppercase">Exchange Rate</label>
                        ...
                        <div>
                            <label className="block text-xs font-medium text-slate-400 mb-1 uppercase">Client Name (Optional)</label>
                            <input
                                type="text"
                                value={clientName}
                ...
                <div className="flex-1 bg-slate-800 rounded-xl border border-slate-700/50 shadow-xl overflow-hidden flex flex-col">
                    <div className="p-4 border-b border-slate-700 bg-slate-800 flex items-center justify-between">
                        ...
                        <button onClick={loadHistory} className="text-slate-400 hover:text-white transition-colors p-1 rounded hover:bg-slate-700">
                            <RefreshCw size={16} />
                        </button>
                    </div>
                                ...
                                {transactions.map((tx) => (
                                    <tr key={tx.id} className="hover:bg-slate-700/20 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-sm font-bold text-emerald-400 text-right">
                                            {parseFloat(tx.amount_in).toLocaleString()} {tx.from_currency}
                                        </td>
                                        <td className="px-6 py-4 text-sm font-bold text-red-400 text-right">
                                            {parseFloat(tx.amount_out).toLocaleString()} {tx.to_currency}
                                        </td>
                                    </tr>
                                ))}
