...
export const FILTER_GROUPS: { group: string; options: FilterOption[] }[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Binance Recv",      type: "FINANCIAL_SERVICE", provider: "BINANCE", service_type: "RECEIVE" },
    ],
  },
  {
    group: "Recharge",
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Whish App Top-up",    type: "RECHARGE_TOPUP", provider: "WHISH_APP"    },
      { label: "OMT App Top-up",      type: "RECHARGE_TOPUP", provider: "OMT_APP"      },
      { label: "OMT System Top-up",   type: "RECHARGE_TOPUP", provider: "OMT_SYSTEM"   },
      { label: "Whish System Top-up", type: "RECHARGE_TOPUP", provider: "WHISH_SYSTEM" },
