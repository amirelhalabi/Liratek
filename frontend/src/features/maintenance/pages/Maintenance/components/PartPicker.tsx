 ...
 * (never sent to the backend — see `toPartsPayload` below); `id` is present
 * only for a line that was loaded from an existing job, so the backend
 * reconciles it instead of re-adding it (MaintenanceRepository.syncParts).
 *
