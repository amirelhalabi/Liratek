...
jest.mock("../backendApi", () => ({
  ...
  getLastCheckpointPerDrawer: jest.fn(async () => null),
  hasInitialBalancesSet: jest.fn(async () => false),
  hasStartingCheckpoint: jest.fn(async () => true),
  ...
  reorderModules: jest.fn(async () => ({ success: true })),
  ...
  getActiveServiceProviders: jest.fn(async () => []),
  getServiceProviders: jest.fn(async () => []),
  createServiceProvider: jest.fn(async () => ({ success: true })),
  updateServiceProvider: jest.fn(async () => ({ success: true })),
  deleteServiceProvider: jest.fn(async () => ({ success: true })),
