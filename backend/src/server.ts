...
import serviceProvidersRoutes from "./api/serviceProviders.js";
...
import drawerCashoutRoutes from "./api/drawerCashout.js";
...
app.use("/api/drawer-cashout", drawerCashoutRoutes);
