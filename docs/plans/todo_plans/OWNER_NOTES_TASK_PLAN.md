...
#### LIRA-078: Debt repayment — cross-currency change returns a phantom credit
...
#### LIRA-079: Counterparty ledgers — no refund/undo path (partner + supplier)
...
#### LIRA-080: Transaction refund — button doesn't disappear after refund; refund UX should use a payment-method modal
...
#### LIRA-081: Refunded maintenance job doesn't show refunded status in the jobs list
...
#### LIRA-082: 'For partner' toggle missing on custom services, maintenance, exchange
...
#### LIRA-085: Exchange transactions excluded from receipt printing
...
#### LIRA-086: Custom service status lifecycle (started / in progress / done)
...
#### LIRA-087: Partial keep-change (keep part of the change, return the rest)
...
#### LIRA-088: Alfa Gift button says "Pay" instead of "Add to Cart" during an active session
...
#### LIRA-089: Dashboard checkpoint time — color-code by staleness
...
#### LIRA-090: Supplier — record debt first, attach inventory products later
