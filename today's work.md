...
- Migrated `CheckoutModal` (shared by POS _and_ Maintenance) off its bespoke payment UI onto the shared `MultiPaymentInput` component — fixes all three bugs at once and adds a new "Waive" button.
