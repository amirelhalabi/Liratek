...
import { AuthenticationError, AuthorizationError, ValidationError, ConflictError, BusinessRuleError, } from "../utils/errors.js";
// =============================================================================
// Auth Service Class
// =============================================================================
export class AuthService {
     ...
     */
    async createUser(data, actorRole) {
        // Authorization check
        if (actorRole !== "admin") {
     ...
     */
    async resetPassword(userId, newPassword, actorRole) {
        // Authorization check
        if (actorRole !== "admin") {
     ...
     */
    deactivateUser(userId, actorId, actorRole) {
        // Authorization check
        if (actorRole !== "admin") {
     ...
     * Reactivate a user
     */
    reactivateUser(userId, actorRole) {
        // Authorization check
        if (actorRole !== "admin") {
     ...
     */
    getAllUsersIncludingInactive(actorRole) {
        if (actorRole !== "admin") {
