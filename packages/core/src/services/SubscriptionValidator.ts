...
class SubscriptionValidatorService {
  ...
  private validationInProgress: Promise<SubscriptionStatus> | null = null;
...
// Singleton instance
let instance: SubscriptionValidatorService | null = null;

/**
 * Get or create the subscription validator instance
 */
export function getSubscriptionValidator(): SubscriptionValidatorService {
  if (!instance) {
