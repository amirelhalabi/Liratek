...
// =============================================================================
// Shared money-string formatting (rule 14 — one formatter, not five)
// =============================================================================
//
// `formatMoneyAmount` used to live here, but it moved to
// `utils/formatMoney.ts` (a zero-import leaf module) so it is reachable from
// BOTH @liratek/core entry points — this module transitively reaches the
// database via utils/payments.js -> PaymentMethodRepository.js ->
// db/connection.js, so a value export of it from browser.ts would break the
// renderer at load. Re-export removed from this module's callers below;
// import it from "../utils/formatMoney.js" instead.
