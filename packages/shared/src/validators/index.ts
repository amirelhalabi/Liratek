...
export const CreateProductRequestSchema = z.object({
  ...
  cost_usd: z.number().min(0, "Cost must be non-negative"),
  price_usd: z.number().min(0, "Price must be non-negative"),
  price_lbp: z.number().min(0, "LBP price must be non-negative"),
  quantity: z
    .number()
...
export const UpdateProductRequestSchema = z.object({
  id: z.number().int().positive(),
  sku: z.string().min(1).regex(VALIDATION.SKU_REGEX).optional(),
...
export const CreateDebtRequestSchema = z.object({
  ...
  original_amount_usd: z
    .number()
    .positive("Debt amount must be greater than 0"),
...
export const SetExchangeRateRequestSchema = z
  .object({
...
export type ChangePasswordRequestValidated = z.infer<
  typeof ChangePasswordRequestSchema
>;
export type CreateUserRequestValidated = z.infer<
  typeof CreateUserRequestSchema
>;
export type UpdateUserRequestValidated = z.infer<
  typeof UpdateUserRequestSchema
>;
export type CreateProductRequestValidated = z.infer<
  typeof CreateProductRequestSchema
>;
export type UpdateProductRequestValidated = z.infer<
  typeof UpdateProductRequestSchema
>;
export type CreateClientRequestValidated = z.infer<
  typeof CreateClientRequestSchema
>;
export type UpdateClientRequestValidated = z.infer<
  typeof UpdateClientRequestSchema
>;
export type CreateSaleRequestValidated = z.infer<
  typeof CreateSaleRequestSchema
>;
export type CreateDebtRequestValidated = z.infer<
  typeof CreateDebtRequestSchema
>;
export type DebtPaymentRequestValidated = z.infer<
  typeof DebtPaymentRequestSchema
>;
export type SetExchangeRateRequestValidated = z.infer<
  typeof SetExchangeRateRequestSchema
>;
export type CreateRechargeRequestValidated = z.infer<
  typeof CreateRechargeRequestSchema
>;
export type CreateOMTRequestValidated = z.infer<typeof CreateOMTRequestSchema>;
export type CreateExpenseRequestValidated = z.infer<
